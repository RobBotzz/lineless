...
export function BaseNavbar({ left, center, right }: BaseNavbarProps) {
  return (
    <header className="sticky top-2 z-50 mx-auto w-[calc(100%_-_3rem)] max-w-7xl rounded-xl border border-border/70 bg-surface/95 [box-shadow:var(--shadow-navbar)] backdrop-blur supports-[backdrop-filter]:bg-surface/90">
