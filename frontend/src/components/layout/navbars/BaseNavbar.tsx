...
export function BaseNavbar({
  ...
  return (
    <header
      className={`sticky top-2 z-50 mx-auto rounded-xl border border-border/70 bg-surface/95 [box-shadow:var(--shadow-navbar)] backdrop-blur supports-[backdrop-filter]:bg-surface/90 ${widthClassName} ${className}`}
    >
